...
<template>
  <div>
    ...
    <el-descriptions :column="2" border style="margin-top: 20px" title="放疗">
      <el-descriptions-item label="开始日期">{{ new Date(data.detail.radiotherapy.start * 1000).format("yyyy-MM-dd") }}</el-descriptions-item>
      <el-descriptions-item label="结束日期">{{ new Date(data.detail.radiotherapy.end * 1000).format("yyyy-MM-dd") }}</el-descriptions-item>
